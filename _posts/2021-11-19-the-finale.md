...
The result is [a simple wrapper](https://github.com/zmike/Xnine) which can be preloaded to run any DXVK-compatible (i.e., any of them that support `-vulkan`) Source game on Nine—and obviously this won't work on NVIDIA at all.
