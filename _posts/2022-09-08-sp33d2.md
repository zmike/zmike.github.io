...
So we're done with GPU optimization, but we're not fast enough yet. The battery still doesn't last forever, and the users are still complaining on Reddit that they can't even finish a casual playthrough of Elden Ring without needing to plug in.
