...
Well, now that the tools exist, it's possible to say definitively that this sort of wishful thinking does not reflect reality. Let's check out the numbers. As of the latest 1.1 `vkoverhead` release, the following tests are available:
