...
## Fast-linking: Comparisons
How fast is Lavapipe's linking, you might ask?

To answer this, let's take a look at comparisons to other, more legitimate drivers, all running on the same system.
...
Lavapipe blows them both out of the water: even if you add the numbers together, it's still not close.
```
...
Intel's ANV driver has a [MR for GPL open](https://gitlab.freedesktop.org/mesa/mesa/-/merge_requests/15637), and it's seeing some movement. Here's a head-to-head.
```
