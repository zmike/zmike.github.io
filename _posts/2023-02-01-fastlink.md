...
On another machine, here's Turnip, which advertises the fast-link feature.
```
$ ./vkoverhead -start 135
...
$ VK_ICD_FILENAMES=lvp_icd.aarch64.json ./vkoverhead -start 135 -duration 3
...
## More Analysis
We've seen that Lavapipe is unequivocally the champion of fast-linking
